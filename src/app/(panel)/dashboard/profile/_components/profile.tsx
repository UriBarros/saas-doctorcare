...
import { UserProfileForm, ProfileFormData } from "./profile-form"
                  ...
                  <Dialog open={dialogIsOpen} onOpenChange={setDialogIsOpen}>
                    <DialogTrigger asChild>
                      <Button variant="outline" className="w-full justify-between cursor-pointer">
                        Clique aqui para configurar horários
                    ...
                    <DialogContent>
                      ...
                      <section className="py-4">
                        <p className="text-sm text-muted-foreground mb-2">
                          Você pode marcar ou desmarcar horários de funcionamento de sua clínica.
                        </p>
                      ...
                      <Button className="w-full cursor-pointer bg-emerald-500 hover:bg-emerald-400" onClick={() => setDialogIsOpen(false)}>
                        Atualizar horários
                      </Button>
